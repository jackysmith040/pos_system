            ...
            <div class="card_body">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered" id='report-list'>
                        ...
                        // Building the date filter query
                        $date_filter = "YEAR(date_created) = '$year'";
                        if (!empty($month)) {
                            $date_filter .= " AND MONTH(date_created) = $month"; // Use the selected month
                        }
                        if (!empty($day)) {
                            $date_filter .= " AND DAY(date_created) = $day";
                        }

                        // Adjust the SQL query to include payment_method
                        ...
                        ?>
                            <tr>
                                ...
                                <td><p><b><?php echo $row['amount_tendered'] > 0 ? $row['ref_no'] : 'N/A' ?></b></p></td>
                                <td><p><b><?php echo $row['order_number'] ?></b></p></td>
                                <td><p class="text-right"><b><?php echo number_format($row['total_amount'], 2) ?></b></p></td>
                                <td><p><b><?php echo $row['payment_method'] ?? 'N/A'; ?></b></p></td> <!-- Display payment method -->
                            </tr>
                        <?php 
                            endwhile; 
                        else: 
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-right"></th> <!-- Empty cell for alignment -->
                            </tr>
                        </tfoot>
                    </table>
                    <hr>
